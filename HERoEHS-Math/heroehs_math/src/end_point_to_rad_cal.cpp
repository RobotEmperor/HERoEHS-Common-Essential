...
Eigen::MatrixXd CalRad::cal_end_point_to_rad(Eigen::MatrixXd eP_) // end point 6 X 8 행렬을 생 6은 xyz roll pitch yaw 8은 trajectory 입력
{
	...
	result_joint(1,0) = cal_end_point_tra_py -> fifth_order_traj_gen(current_pose_change(1,0), eP_(1,1), current_pose_change(1,1), eP_(1,3), current_pose_change(1,2), eP_(1,5), eP_(1,6), eP_(1,7));
	result_joint(2,0) = cal_end_point_tra_pz -> fifth_order_traj_gen(current_pose_change(2,0), eP_(2,1), current_pose_change(2,1), eP_(2,3), current_pose_change(2,2), eP_(2,5), eP_(2,6), eP_(2,7));

	result_joint(3,0) = cal_end_point_tra_alpha -> fifth_order_traj_gen(current_pose_change(3,0), eP_(3,1), current_pose_change(3,1), eP_(3,3), current_pose_change(3,2), eP_(3,5), eP_(3,6), eP_(3,7));
	result_joint(4,0) = cal_end_point_tra_betta -> fifth_order_traj_gen(current_pose_change(4,0), eP_(4,1), current_pose_change(4,1), eP_(4,3), current_pose_change(4,2), eP_(4,5), eP_(4,6), eP_(4,7));
	result_joint(5,0) = cal_end_point_tra_kamma -> fifth_order_traj_gen(current_pose_change(5,0), eP_(5,1), current_pose_change(5,1), eP_(5,3), current_pose_change(5,2), eP_(5,5), eP_(5,6), eP_(5,7));
