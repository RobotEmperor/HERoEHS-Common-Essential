...
#include <sstream>
#include <stdio.h>
#include "../include/offset_tuner_operation/qnode.hpp"
...
bool QNode::init() {
	...
	action_command_pub = n.advertise<std_msgs::String>("/heroehs/action_command", 100);
	init_pose_pub = n.advertise<std_msgs::String>("/heroehs/init_pose", 100);
	sound_pub = n.advertise<std_msgs::String>("/heroehs/sound", 100);
	...
	//motion
	editor_command_cl = n.serviceClient<motion_editor_msgs::EditorCommand>("/heroehs/editor_command");
