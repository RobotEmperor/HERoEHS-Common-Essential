...
[ port info ]
# PORT NAME  | BAUDRATE
/dev/ttyUSB0| 3000000  | l_shoulder_pitch   
...
dynamixel | /dev/ttyUSB0 |  5   | MX-64-5       | 2.0      | l_shoulder_yaw     | present_position
dynamixel | /dev/ttyUSB0 |  6   | MX-64-6       | 2.0      | r_shoulder_yaw     | present_position

dynamixel | /dev/ttyUSB0 |  7   | MX-28-7       | 2.0      | l_elbow_pitch      | present_position
dynamixel | /dev/ttyUSB0 |  8   | MX-28-8       | 2.0      | r_elbow_pitch      | present_position
